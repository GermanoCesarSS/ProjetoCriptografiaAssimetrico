...
namespace ProjetoCriptografiaAssimetrico
{
    public partial class Form1 : Form
    {
        ...
        const string EncrFolder = @"c:\Users\Public\Documents\Encrypt\";
        const string DecrFolder = @"c:\Users\Public\Documents\Decrypt\";
        const string SrcFolder = @"c :\Users\Public\Documents\";

        // Public key file
        const string PubKeyFile = @"c:\Users\Public\Documents\Encrypt\rsaPublicKey.txt";

        // Key container name for
        // private/public key value pair.
        const string KeyName = "Chaves01"; //Nome do contêiner de chaves
        ...
        private void buttonCreateAsmKeys_Click(object sender, EventArgs e) {
            ...
            label1.Text = _rsa.PublicOnly
                ? $"Chave: {_cspp.KeyContainerName} - Chave Pública"
                : $"Chave: {_cspp.KeyContainerName} - Par de Chave Completo (Pública e Privada)";
        }
        private void buttonEncryptFile_Click(object sender, EventArgs e) {
            if (_rsa is null) {
                MessageBox.Show("Chave nula.");
            }
            else {
